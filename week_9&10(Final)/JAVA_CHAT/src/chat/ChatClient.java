...
public class ChatClient implements Runnable {
	...
	void personalchat() { //해당 메소드를 호출하면 카톡처럼 1대1 채팅할 수 있는 채팅창이 나온다.
		personalchat = new PersonalChat(ChatClient.this);
	}

	private void whisper(String id, String nick, String msg) {
		//오른쪽으로 채팅 나오게 해보기
		personalchat.waitRoomArea.append(id+ ": " + msg + "\n");
	}
